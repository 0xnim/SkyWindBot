...
class Embed(discord.Embed):
    ...
    async def set_made_with_love_footer(self):
        ...
        return super().set_footer(text=f"Made with 💖 by Nim1com", icon_url=self.bot.user.avatar_url)

    async def set_patron_footer(self):
        return super().set_footer(text=f"Thanks for your support! https://patreon.com/taveldevs", icon_url=self.bot.user.avatar_url)
